    ...
    public partial class FrmMain : Form
    {
        ...
        private void btnThemKhuVuc_Click(object sender, EventArgs e)
        {
            ...
            frmThemKhuVuc.OnTenKhuVucAdded += FrmThemKhuVuc_TenKhuVuc;
        ...
        private void FrmThemKhuVuc_TenKhuVuc(string maDinhDanh, string tenKhuVucMoi)
        {
        
            //throw new NotImplementedException();
            int khuVuc = dgvKhuVuc.Rows.add();
            //cmbKhuVuc.Items.Add(tenKhuVucMoi);
            dgvKhuVuc.Rows[khuVuc].Cells[0].Value = maDinhDanh;
            dgvKhuVuc.Rows[khuVuc].Cells[1].Value = tenKhuVucMoi;
        }
